        ...
        <div class="table-responsive cart-table-box">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ DEFAULT_CURRENCY.@$cart['price'] }}</td>
                    <td><a href="{{ route('remove-cart-item',$cart['id']) }}" class=" delete-new-bt" onclick="return confirm(' Are you sure you want to remove this item? ')"><i class="fa fa-trash"  aria-hidden="true"></i> Delete</a><td>
                </tr>
                @endforeach
            </tbody>
            </table>
            ...
            <div class="offset-7 col-5">
                <div class="total-amount-area">
                   ...
                   ?>
                    ...
                    <form method="post" action="{{ route('stripe-ideal') }}">
                        @csrf
                        <input type="hidden" name="price" value="{{$totalprice}}">
                        <input type="submit" class="sign-bt mb-0" value="PROCEED TO PAYMENT"/>
                    </form>
