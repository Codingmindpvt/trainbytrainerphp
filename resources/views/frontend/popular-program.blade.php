		...
		<div class="blue-overlay">
			<div class="container">
				<div class="popular-box text-center">
					<h1 class="oswald-font">The Most Popular Online Workout Programs</h1>
					<span class="divide-line"></span>
					<h3 class="oswald-font">If you're looking for a new workout program to try, we've got you covered!</h3>
        		...
        		<div class="col-md-12">
            		<div class="d-flex w-100 popular-main">
		                <ul id="tabsJustified" class="nav nav-pills flex-column w-50">
		                    <li class="nav-item"><a href="" data-target="#home1" data-toggle="tab" class="nav-link small text-capitalize"><h2 class="oswald-font">Most Popular Home Workout Program:</h2></a></li>
		                    <li class="nav-item"><a href="" data-target="#profile1" data-toggle="tab" class="nav-link small text-capitalize active"><h2 class="oswald-font">Most Popular Core Strength Program:</h2></a></li>
		                    <li class="nav-item"><a href="" data-target="#messages1" data-toggle="tab" class="nav-link small text-capitalize"><h2 class="oswald-font">Most Popular Equipment Program:</h2></a></li>
		                    <li class="nav-item"><a href="" data-target="#messages2" data-toggle="tab" class="nav-link small text-capitalize"><h2 class="oswald-font">Most Popular Block Program:</h2></a></li>
		                </ul>
                        ...
                        <div class="card">
                            <div class="card-header" id="faqHeading-1">
                                <div class="mb-0">
                                    ...
                                    Benefits of an Online Workout Program
                                    </h5>
                                </div>
                            </div>
