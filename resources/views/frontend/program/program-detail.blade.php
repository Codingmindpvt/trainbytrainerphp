                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="result-slider">
                            ...
                            <div class="slider-content text-center">
                                ...
                                <p class="review-rate">
                                <div class="rating">
                                    <div class="rateyo" data-rateyo-rating="{{ @$item['certificate']}}"
                                        data-rateyo-num-stars="5"></div>
                                </div>
                                </p>
        ...
        <div class="container">
            ...
            <div class="review-view">
                ...
                <div class="review-view">
                    ...
                    // {
                    if (strlen($string) >= 50) {
                        echo substr($string, 0, 50) . '<span class="read_more_program" style="color:blue;">Read More</span>' . '<span class="show_read_more_program" style="display:none;">' . substr($string, 50) . '</span>' . '<span class="show_less_program" style="color:blue; display:none;" style="color:blue;">Show Less</span>';
                    }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body write-review-modal">
                    ...
                    <form id="frm" class="review_validate text-left">
                        ...
                        <!-- stars section start -->
                        <div id="rateYo"
                            data-rateyo-rating="{{!empty(@$myReviewDetail['star']) ? @$myReviewDetail['star'] : 0}}"
                            data-rateyo-num-stars="5"></div>
                        <input type="hidden" id="inpt_rating" name="star" value="{{@$myReviewDetail['star']}}">
                        <!-- star section end -->
                        <div class="form-group">
                            <label for="formGroupExampleInput">Title</label>
                            <input type="text" class="form-control form-input" name="title" placeholder="Enter Title Line">
