...
<section class="coach-profile-banner program profile-banner">
    <!-- Swiper -->
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            ...
            <div class="slide-image">
                ...
                <img src="{{ asset('public/' . @$programs->image_file) }}" class="img-circle profile_image_small" />
                @else
        ...
        <div class="coach-information">
            ...
            <div class="insta-save">
                ...
                <div class="buy_now_section">
                    ...
                    @else
                        @if(!empty(Auth::check()) && !empty(Auth::id()))
                        <span class="open-chat ml-3 buy_now"> BUY NOW {{ DEFAULT_CURRENCY.@$programs['price'] }}</span>
                        @else
                        <a  href="{{ route('login') }}" class="open-chat ml-3"> BUY NOW {{ DEFAULT_CURRENCY.@$programs['price'] }}</a>
                        @endif
                    @endif
                ...
                <div class="swiper-slide">
                    ...
                    <div class="result-slider">
                        ...
                        <div class="slider-content text-center">
                            ...
                            <p class="review-rate">
                            <div class="rating">
                                <div class="rateyo" data-rateyo-rating="{{ @$item['certificate']}}" data-rateyo-num-stars="5"></div>
                            </div>
                            </p>
            ...
            <div class="col-md-4">
                <div class="program-one">
                    <div class="button-section">
                        ...
                        @else
                        <a href="{{route('login')}}"><span class="view-save-bt">
                                <i class="fa fa-heart-o" aria-hidden="true"></i> SAVE</span>
                        </a>
                    ...
                    <a href="{{ route('program-detail',$item->id) }}">
                        ...
                        <div class="barberll-content">
                            <div class="doller-review">
                                ...
                                <?php $reviewDetail = $item->getReviewAndRatingDetail($item['user_id']); ?>
                                <p class="review-rate">
                                <div class="rating">
                                    <div class="rateyo" data-rateyo-rating="{{ !empty(@$reviewDetail['avg_rating']) ? @$reviewDetail['avg_rating'] : 0 }}" data-rateyo-num-stars="5"></div>
        ...
        <div class="review-view">
            ...
            <div class="review-view">
                ...
                if (strlen($string) >= 399) {
                    echo substr($string, 0, 399) . '<span class="read_more_program" style="color:blue;">Read More</span>' . '<span class="show_read_more_program" style="display:none;">' . substr($string, 399) . '</span>' . '<span class="show_less_program" style="color:blue; display:none;" style="color:blue;">Show Less</span>';
                }
                ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body write-review-modal">
                ...
                <form id="frm" class="review_validate text-left">
                    ...
                    <input type="hidden" name="rate_for_coach_id" value="{{@$programs['user_id']}}">
                    <!-- stars section start -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="title" placeholder="Enter Title Line" value="{{!empty(@$myReviewDetail['title'])? @$myReviewDetail['title'] : ""}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" required name="description" id="exampleFormControlTextarea1" rows="4" placeholder="Enter Description">{{!empty(@$myReviewDetail['description'])? @$myReviewDetail['description'] : ""}}</textarea>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    window.location.href =
                        "{{ route('program-detail',@$programs->id) }}#coach-review-area";

                    // window.location.href ="{{url('')}}http://localhost/trainbytrainerphp/programs/program-detail/2#coach-review-area";
                    location.reload();
                }
            });
        });
