<div class="tab-pane fade loop_for_data" id="Fri" role="tabpanel" aria-labelledby="home3-tab" data-type="friday">
    <div class="row append_friday_div div_scroll">

        @if (isset($schedules['fri']) && !empty($schedules['fri']) && count($schedules['fri']) > 0)

            @foreach ($schedules['fri'] as $value)


                <aside class="col-md-12 clone_friday_div">
                    <div class=" row borderHide">
                        ...
                        <aside class="col-md-3 clock-box">
                            ...
                            <input type="text" id="" class="form-control timepicker from_time from_time_class" value="{{ $value->from_time  }}"
                                data-type="friday" placeholder="Select time">
                            <span class="friday_errors friday_from_time_error"></span>
                        </aside>
                        ...
                        <aside class="col-md-3 clock-box ">
                            ...
                            <input type="text" id="default-picker" class="form-control timepicker to_time " value="{{ $value->to_time  }}
                                data-type="friday" placeholder="Select time">
                            <span class="friday_errors friday_to_time_error"></span>
    ...
    <a href="" class="add-btn my-3 friday_add_more_button add_more_button" data-type="friday" style="font-size: 14px;
