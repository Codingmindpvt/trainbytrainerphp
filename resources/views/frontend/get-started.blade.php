                    ...
                    <form class="form" method="post" id="signupForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="coach-choice" id="coach">
                                <input type="radio" id="show" class="radio role_type" name="role_type" value="{{ $user->isRoleUser()}}" <?= (empty(old('role_type')) || old('role_type') != $user->isRoleCoach()) ? "checked" : ""; ?>>
                                <p class="form-input text-left">Find a coach or program </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="coach-choice" id="become">
                                <input type="radio" id="hide" class="radio mt-2 role_type" name="role_type" value="{{$user->isRoleCoach()}}" <?= (!empty(old('role_type')) && old('role_type') == $user->isRoleCoach()) ? "checked" : ""; ?>>
                            ...
                            <div class="personal-gp row personal-bus-error">
                                <div class="col-sm-6">
                                    <div class="coach-choice">
                                        <input type="radio" id="user_type" class="radio" name="user_type" value="{{$user->userTypePersonal()}}" <?= (!empty(old('role_type')) && old('role_type') == $user->isRoleUser() && old('user_type') == $user->userTypePersonal()) ? "checked" : ""; ?>>
                                        <p class="form-input text-left">Personal</p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="coach-choice">
                                        <input type="radio" id="user_type" class="radio" name="user_type" value="{{$user->userTypeBusiness()}}" <?= (!empty(old('role_type')) && old('role_type') == $user->isRoleUser() && old('user_type') == $user->userTypeBusiness()) ? "checked" : ""; ?>>
                        ...
                        <div class="form-check agree-checkbox">
                            ...
                            <p>I read and agree to <a href="{{route('termscondition')}}" target="_blank">Terms &
                                    Conditions</a> and <a href="{{route('privacyPolicy')}}" target="_blank">Privacy
                                    Policy</a>.</p>
