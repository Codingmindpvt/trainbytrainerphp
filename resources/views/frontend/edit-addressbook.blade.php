            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="user-profle-right-side">
                        ...
                        <hr>
                        <form id="updatebilling" class="input-box"
                            action="{{ route('update-address-billing', $billing->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="company_name"
                                                ...
                                                placeholder="E.g. Train By Trainers">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" class="form-control"
                                                ...
                                                placeholder="E.g. 202 Main Town, Dolphin Chowk">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="country" id="exampleFormControlSelect1">
                                                ...
                                                @foreach ($countries as $country)
                                                    ...
                                                    <option value="{{ $country->id }}" {{ ($billing->country_id == $country->id) ? 'selected' : '' }}>{{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="state_id" id="exampleFormControlSelect1">
                                                ...
                                                @foreach ($states as $state)
                                                    <option value="{{ @$state->id }}"  {{ ($billing->state_id == $state->id) ? 'selected' : '' }}>{{ $state->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="city" class="form-control"
                                                value="{{ @$billing->city }}" placeholder="E.g. Los Angeles">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="postal_code" class="form-control"
                                                value="{{ @$billing->postal_code }}" id="formGroupExampleInput"
                                    ...
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox checkbox-area">
                                            <input type="checkbox" class="custom-control-input" value="1" name="default"
                                                id="customCheckBox1">
                                            <label class="custom-control-label" for="customCheckBox1">Use as my default
                                    ...
                                    <div class="col-md-6">
                                        <input type="submit" name="submit" value="update" class="blue-btn oswald-font" />
                                    </div>
                                    <div class="col-md-6">
                                        <div class="new-main">
