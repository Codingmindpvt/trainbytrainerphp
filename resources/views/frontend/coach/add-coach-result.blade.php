                ...
                <div class="ceritified-diploma-box">
                    ...
                    <div class="modal-body write-review-modal mb-4 cerified-modal">
                        <div class="certified-form">
                            <form action="{{route('coach.create-coach-result')}}" method="POST" class="add-coach-result"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{@$coachDetail['id']}}" name="coach_detail_id">
                                    ...
                                    <div class="upload-certificate-box-main">
                                        <div class="upload-certificate-box">
                                            <img src="{{asset('public/images/default-image-file-o.png') }}"
                                                class="mr-3 profile_picture" alt="upload">
