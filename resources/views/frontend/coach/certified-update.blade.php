                        ...
                        <div class="certified-form">
                            <form action="{{route('coach.certificate-diploma-update')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$certificateDiploma['completion_year']}}"
                                        class="form-control" name="completion_year" id="pwd" placeholder="2011">
                                </div>
                                <div class="form-group">
                                    <label for="pwd">Institute or organisation </label>
                                    <input type="text" value="{{$certificateDiploma['institute']}}" class="form-control"
                                        name="institute" id="pwd" placeholder="Victorian Fitness Academy">
                                </div>
