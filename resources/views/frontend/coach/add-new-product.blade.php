			...
			<div class="row">
				<aside class="col-lg-4">
					...
					<div class="tab-content">
                        ...
                        <li>
                             <a href="add-new-product.html" class="active"><i class="fa fa-cart-plus mr-3" aria-hidden="true"></i>New Products</a>
                        </li>
                        <li>
				...
				<aside class="col-lg-8 marketplace-main-box varification-box">
					...
					<div class="sale-by-location">
						...
						<a href="add-new-program-2.html" class="blue-btn oswald-font my-3">CONTINUE</a>
					</div>
				</aside>
			</div>
		</div>
