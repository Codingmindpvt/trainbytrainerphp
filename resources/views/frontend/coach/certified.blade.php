                ...
                <div class="ceritified-diploma-box">
                    ...
                    <div class="certified-area">
                        ...
                        <div class="certified-box-right delete-cart">
                            <a href="{{ route('coach.certificate-diploma-delete',$certificateDiploma['id']) }}"
                                onclick="return confirm('Are you sure you want to delete this record?')"><i
                                    class="fa fa-trash" aria-hidden="true"></i></a>
                            <a href="{{ route('coach.certificate-diploma-edit',$certificateDiploma['id']) }}"><i
                                    class="fa fa-pencil edit-pencil-new" aria-hidden="true" data-toggle="modal"
                                    data-target="#edit-certified_{{$certificateDiploma['id']}}"></i></a>
                        </div>
                    </div>
                    @empty
