    ...
    <div class="container">
        <div class="row">
            ...
            <aside class="col-lg-8 marketplace-main-box varification-box">
                ...
                <form method="post" id="coachVerificationForm" action="{{ route('coach.add-verification') }}"
                    ...
                    <div class="sale-by-location">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input"
                                        value="{{$verificationDetail->isQualificationYes()}}"
                                        name="qualified_fitness_coach">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input"
                                        value="{{$verificationDetail->isQualificationNo()}}"
                                        name="qualified_fitness_coach">No
                                </label>
                            </div>
                        </div>
                        <div class="view-box">
                        ...
                        <div class="view-box">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input"
                                        value="{{$verificationDetail->isInsuranceYes()}}" name="currently_insured">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input"
                                        value="{{$verificationDetail->isInsuranceNo()}}" name="currently_insured">No
                                </label>
                            </div>
                        </div>
                        <div class="view-box">
                        ...
                        <div class="view-box">
                            ...
                            <div class="cal-box">
                                <input class="form-input" id="datepicker" type="date" min="{{ date('Y-m-d')}}"
                        ...
                        <p class="imsurance-box">Being a qualified fitness coach does not mean you can coach anyone
                            about anything fitness
                            related. A qualification only allows you to coach certain types of people and categories.
                        </p>
                        <div class="form-check agree-checkbox">
                            ...
                            <p class="text-left">I confirm that I know what clients my qualification allows me to coach
