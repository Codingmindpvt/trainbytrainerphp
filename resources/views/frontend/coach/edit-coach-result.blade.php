        ...
        <div class="row">
            ...
            <aside class="col-lg-8 marketplace-main-box">
                <div class="marketplace-header">
                    <h3 class="oswald-font">Coach Profile Result</h3>
                </div>
                <div class="ceritified-diploma-box">
                    ...
                    <div class="modal-body write-review-modal mb-4 cerified-modal">
                        <div class="certified-form">
                            <form action="{{route('coach.update-coach-result')}}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-select">
                                        <select class="form-input" id="result_star" name="star">
                                            ...
                                            <option value="1" {{ ($result['star'] == 1) ? "selected" : "" }}>1 Star
                                            </option>
                                            <option value="2" {{ ($result['star'] == 2) ? "selected" : "" }}>2 Stars
                                            </option>
                                            <option value="3" {{ ($result['star'] == 3) ? "selected" : "" }}>3 Stars
                                            </option>
                                            <option value="4" {{ ($result['star'] == 4) ? "selected" : "" }}>4 Stars
                                            </option>
                                            <option value="5" {{ ($result['star'] == 5) ? "selected" : "" }}>5 Stars
                                            </option>
                                        </select>
                                    </div>
                                </div>
