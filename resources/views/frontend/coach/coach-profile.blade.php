            ...
            <div class="row">
                ...
                <aside class="col-lg-8 marketplace-main-box varification-box">
                    ...
                    <div class="sale-by-location">
                        <h4 class="oswald-font">Profile Information</h4>
                        <div class="view-box">
           ...
           <div class="page_image_validation" style="display:none; color:red"> Upload Max 5 Files allowed <b id="total_page_images"></b></div>
                    ...
                    <div class="view-box">
                        <p class="my-2 form-p">My Title <span> <i class="fa fa-asterisk validate-mark"
                                    aria-hidden="true"></i></span></p>
                        <input class="form-input" type="text" name="title" placeholder="Enter Title">
                    ...
                    <div class="view-box">
                        <p class="my-2 form-p">My Bio <span> <i class="fa fa-asterisk validate-mark"
                                    aria-hidden="true"></i></span></p>
                        <textarea class="form-input" name="bio" placeholder="Enter Bio"></textarea>
                        <p class="tag-line">This will appear under your name on your coach profile page. It
                            will help clients get to know you better.</p>
                    </div>
                    <hr>
                    <div class="view-box">
                        <p class="my-2 form-p">Coach Categories <span> <i class="fa fa-asterisk validate-mark"
                                    aria-hidden="true"></i></span></p>
                        <div class="form-select">
                            <select class="form-input multiSelectDropDown" name="categories[]" id="categories" multiple>
                    ...
                    <div class="view-box">
                        ...
                        <div class="form-select">
                            <select class="form-input multiSelectDropDown" name="personality_and_training[]"
                                id="personality_and_training" multiple required>
                    ...
                    <div class="view-box">
                        <p class="my-2 form-p">Languages <span> <i class="fa fa-asterisk validate-mark"
                                    aria-hidden="true"></i></span></p>
                        <div class="form-select">
                            <select class="form-input multiSelectDropDown" name="languages[]" id="languages" multiple
                                required>
                    ...
                    <div class="field_wrapper">
                        <div class="main-section">
                            ...
                            <div class="view-box">
                                ...
                                <input class="form-input _institute" type="text" name="institute_1"
                                    placeholder="Enter Institute Name">

                            </div>
                        </div>
                    </div>
                    <a href="javascript:void(0);" class="add_button add-btn my-3" title="Add field"><span>Add More <i
                            ...
                            <div class="view-box">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-input _title" type="text" placeholder="Enter Results Title"
                                            name="result_title_1">
                                    </div>
                                    <div class="form-group col-md-6">
                            ...
                            <div class="view-box">
                                <div class="form-row">
                                        ...
                                        <div class="upload-certificate-box-main">
                                            <div class="upload-certificate-box upload-err">
                                                ...
                                                <input name="result_image_file_1" type="file"
                                                    class="file imgUpload imgUpload_1 img5 _result_image"
                                                    data-show-upload="false" data-show-caption="true"
                                    ...
                                    <div class="form-group col-md-10">
                                        ...
                                        <textarea class="form-input _description"
                                            placeholder="Enter Results Description"
                                            name="result_description_1"></textarea>
                                    </div>
                                </div>
...
$(document).ready(function() {
   ...
   @endforeach
            ...
            </div></div><div class="view-box"><p class="tag-line">Institute or organisation</p><input class="form-input _institute"  placeholder="Enter Institute Name"type="text" id="institute_` +
                count + `" name="institute_` +
                count +
    ...
    function reArrangeEducation() {
        $(".main-section").each(function(index) {
            var edu = index + 1;
            $(this).find('._education_title').attr('name', 'education_title_' + edu)
            $(this).find('._education_title').attr('id', 'education_title_' + edu)

            $(this).find('._completion_year').attr('name', 'completion_year_' + edu)
            $(this).find('._completion_year').attr('id', 'completion_year_' + edu)

            $(this).find('._institute').attr('name', 'institute_' + edu)
            $(this).find('._institute').attr('id', 'institute_' + edu)
...
$(document).ready(function() {
    ...
    $(resultAddButton).click(function(e) {
        ...
        if (result_count < resultMaxField) {
            ...
            $(resultWrapper).append(
                `<div class="result-main-section"><div class="view-box">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <p class="tag-line">Title</p>
                                    <input class="form-input _title" type="text"  placeholder="Enter Results Title" id="result_title_` +
                result_count + `"  name="result_title_` +
                result_count + `">
                                </div>
                                <div class="form-group col-md-6">
                                    <p class="tag-line">Stars</p>
                        ...
                        <div class="view-box">
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <p class="tag-line">Image</p>
                                    <div class="upload-certificate-box">
                                        {{-- <img src="{{asset('public/images/default-image-file-o.png')}}" class="imgPreview" id="imgPreview_` +
                result_count + `"  alt="upload">
                                        <input id="imgUpload_` + result_count + `" name="result_image_file_` +
                result_count + `"  accept="image/jpeg, image/jpg, image/png"type="file" class="file imgUpload _result_image" data-show-upload="false" data-show-caption="true" data-msg-placeholder="Select for upload..."> --}}
                                        <div class="upload-certificate-box upload-err">
                ...
                `"  class="file imgUpload1"
                                ...
                                <div class="form-group col-md-10">
                                    <p class="tag-line">Description</p>
                                    <textarea class="form-input _description"  placeholder="Enter Results Description" id="result_description_` +
                result_count + `" name="result_description_` +
    ...
    function reArrangeResult() {
        $(".result-main-section").each(function(index) {
            var res = index + 1;
            $(this).find('._title').attr('name', 'result_title_' + res)
            $(this).find('._title').attr('id', 'result_title_' + res)

            $(this).find('._description').attr('name', 'result_description_' + res)
            $(this).find('._description').attr('id', 'result_description_' + res)

            $(this).find('._result_image').attr('name', 'result_image_file_' + res)
            $(this).find('._result_image').attr('id', 'result_image_file_' + res)

            $(this).find('._star').attr('name', 'star_' + res)
            $(this).find('._star').attr('id', 'star_' + res)
