...
<section class="profesional-common-box">
		<div class="container">
			<p><img src="{{asset('public/images/notify.png')}}"  class="mr-2" alt="notify">Your Certification Request has been rejected by admin, Please resubmit your Certification Detail and check your email for the reason.
		</div>
</section>
@endif
            ...
            <aside class="col-lg-8 marketplace-main-box varification-box">
                <div class="marketplace-header">
                    ...
                    <a href="{{route('edit-coach-verification', $verificationDetail->id)}}">
                        <div class="save-green-bt coming_soon"> <i class="fa fa-pencil" aria-hidden="true"></i> EDIT Verification</div>
                    </a>
                    @if($verificationDetail->badge_status == 'S')
