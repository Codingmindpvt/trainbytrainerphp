<div class="tab-pane fade" id="home7" role="tabpanel" aria-labelledby="home6-tab">
    @php $details = $schedule_result['Sat'][0] ?? array(); @endphp
    @isset($details)
                ...
                <aside class="col-md-3">
                    ...
                    @if (isset($detail['class']['attendees_limit']) && $detail['class']['attendees_limit'] > 0)
                        ...
                        @elseif($booking_status == 1)
                            <a class="blue-btn oswald-font my-3 text-light" data-id="{{ $detail['id'] }}"> Booking request
                                sent</a>
                        @else
