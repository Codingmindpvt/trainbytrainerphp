                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-8 col-md-10">
                                        <div class="coach-information">
                                            <h2>{{ ucwords(@$item['users']['first_name'] . ' ' . @$item['users']['last_name']) }}<span><img
                                                        src="{{ url('/') }}/public/images/verified2.png" alt="image"
                                                        class="img-fluid">{!! @$item['users']->getCoachBadgeStatus() !!}</span></h2>
                                            <ul>
                                            ...
                                            <p class="review-rate"><i class="fa fa-star" aria-hidden="true"></i> <i
                                    ...
                                    <div class="col-lg-2 col-md-12 button-section">
                                        ...
                                        <a href="{{ route('coaches.profile', @$item['users']['id']) }}"
                                            class="view-profile-bt">VIEW PROFILE</a>
                                        @if (Auth::check() && Auth::user()->id)
                                            ...
                                            @else
                                                <div class="button-wrapper">
                                                    <span id="wishList" class="view-save-bt add_to_wishlist"><i
                                                            class="fa fa-heart-o" aria-hidden="true"></i> SAVE</span>
                                                </div>
                                            @endif
                                        @else
