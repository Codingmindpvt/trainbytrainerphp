				...
				<aside class="col-lg-8 marketplace-main-box varification-box">
					...
					<div class="sale-by-location">
						<div class="view-box">
							...
							<p>Save your bank account information using stripe connect if not added. If routing number or any
							other information changes please reauthorize using the Stripe system.</p>
						</div>
