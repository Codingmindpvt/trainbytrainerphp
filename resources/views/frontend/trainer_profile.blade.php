...
<div class="coaches-name">
    <div class="container">
        ...
        <h6><span><a href="{{ route('coaches')}}" class="active-program">Coaches</span></a> >
            {{@$userProfile->getFullName()}}</h6>
    </div>
</div>
...
<section id="overview-area">
            ...
            <div class="col-md-8">
                <div class="coach-information">
                    ...
                    <div class="insta-save save-btn">
                        ...
                        @else
                        <a href="{{route('login')}}"> <button class="view-save-bt"><i class="fa fa-heart-o"
                                    aria-hidden="true"></i> SAVE</button></a>
    ...
    -->
                        ...
                        {{--  <a href="{{ !empty(@$userProfile['coach_detail']['instagram_url']) ? @$userProfile['coach_detail']['instagram_url'] : '#' }}"
                        class="view-insta-bt"><i class="fa fa-instagram" aria-hidden="true"></i> INSTAGRAM</a> --}}
                    </div>
                    <ul>
                        <li><b>{{ !empty(@$userProfile['coach_detail']['price_range']) ? @$userProfile['coach_detail']['price_range'] : "-----" }}</b>
                        </li>
                        <li>-</li>
                        <li>{{ !empty(@$userProfile['coach_detail']['title']) ? @$userProfile['coach_detail']['title'] : "-----" }}
                        </li>
                        <li>-</li>
                        <li><i class="fa fa-map-marker" aria-hidden="true"></i>
                            {{ @$userProfile->state->name}}.{{  @$userProfile->country->name}}</li>
                    </ul>
                    <div class="review-rate mb-2">
                        ...
                        <div class="rateyo"
                            ...
                            data-rateyo-num-stars="5">" data-rateyo-num-stars="5"></div>



                        ({{count(@$reviewList)}} Reviews)
                    </div>
                    ...
                    <p class="mt-2 mb-4">
                        {{ !empty(@$userProfile['coach_detail']['bio']) ? @$userProfile['coach_detail']['bio'] : "-----" }}
                    </p>

                </div>
                @if(isset($userProfile['coach_detail']['chat_status']) && $userProfile['coach_detail']['chat_status'] ==
                "E")
                <a class="open-chat" href="{{route('chat',$userProfile['coach_detail']['user_id'] )}}">OPEN CHAT</a>
                @endif
                {{-- <a href="{{ route('program-detail',$program->id) }}"> --}}
                <a class="program-chat" href="#coach-program-area">VIEW PROGRAMS
                    <!-- (20) -->
                </a>
            </div>
            <div class="col-md-4">
                <div class="personality-style">
                    ...
                    @else
                    <p class="no-record-placeholder">This Coach doesn't currently have any education listed. If you want
                        to know more about their qualifications, please reach out to them through the Open Chat button.
                    </p>
                    @endif
                </div>
            </div>
...
<section id="coach-result-area">
    <div class="container">
        ...
        <div class="two-arrow">
            <div class="swiper-button-next"> <img class="right-arrow" src="{{asset('public/images/right-arrow.png')}}">
            </div>
            <div class="swiper-button-prev"><img class="left-arrow" src="{{asset('public/images/left-arrow.png')}}">
            </div>
        </div>
        <p class="mt-2 mb-4" style="font-family: 'Oswald';">View the results of people who have been trained by this
            coach.</p>
...
<section id="coach-program-area">
    <div class="container">
        ...
        {{--  @if($allCoachPrograms['detailCount'] > 3)
                <p class="text-center m-5"><a href="{{route('programs')}}" class="program-chat">VIEW ALL PROGRAMS</a>
        </p>
        @endif --}}
    </div>
</section>
