                ...
                <div class="col-md-4">
                    ...
                    <div class="program-one new-one-program">
                        <div class="barbell-image">
                            ...
                            <a href="{{url('classes-detail')}}/{{$class->id}}">
                        ...
                        <div class="barberll-content">
                            <div class="doller-review">
                                <h4>{{(isset($class->price) && !empty($class->price)) ? DEFAULT_CURRENCY.$class->price : "-----"}}  <span class="session-text">/session</span></h4>
                                <p class="session-time"> 6:00 AM - 10:00 PM</p>
                            </div>
                            <h3>{{(isset($class->name) && !empty($class->name)) ? $class->name : "-----"}}</h3>
                            <h6>CREATED BY: {{ (isset($class['program_user']['first_name']) && !empty($class['program_user']['first_name'])) ? strtoupper(@$class['program_user']['first_name'] . ' ' . @$class['program_user']['last_name']) : "-----"}}</h6>
