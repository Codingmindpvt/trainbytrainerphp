            ...
            <div class="coaches-info">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2 col-md-2">
                        @if (!empty(@$item->coach_detail->image_file))
                        <img src="{{ asset('public/' . @$item->coach_detail->image_file) }}"
                            class="img-fluid img-rounded" />
                        @elseif (!empty(@$item->profile_image))
                    ...
                    <div class="col-lg-8 col-md-10">
                        <div class="coach-information">
                            ...
                            <?php $reviewDetail = $item->getReviewAndRatingDetail($item['coach_detail']['user_id']); ?>

                            <div class="review-rate">
                                <div class="rating">

                                    @if(!empty($reviewDetail['avg_rating']))
                                    <div class="rateyo" data-rateyo-rating="{{@$reviewDetail['avg_rating'] }}"
