<div class="category-filter">
    ...
    <div class="price-filter">
        <div class="custom-control custom-checkbox checkbox-area">
            <input type="checkbox" class="custom-control-input price_filter_checkbox" id="customCheckBox2" value="€€" <?php
        ...
        <div class="custom-control custom-checkbox checkbox-area">
            <input type="checkbox" class="custom-control-input price_filter_checkbox" id="customCheckBox3" value="€€€"
                @php if (isset($price_ids) && in_array('€€€', $price_ids)) { echo 'checked' ; } else { echo '' ; }
                @endphp>
