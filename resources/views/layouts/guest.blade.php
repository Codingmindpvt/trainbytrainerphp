...
<body>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdsjb_RUMEkFt5eBE1iyaHrY-FVEiyMSI&callback=initMap&libraries=places">
    </script>
    ...
    <!-- <script src="{{asset('public/js/jquery.dynamicmaxheight.js')}}"></script> -->
    ...
    function SwalOverlayColor() {
        setTimeout(function() {
            ...
            $(".swal-button--cancel").css({
                "background-color": '#555',
                "color": "#fff"
            });
            $(".swal-button--danger").css({
    ...
    /***************************************************/
    $('.sureDelete').click(function(event) {
    ...
    /* Confirmation on Proceed Payment */

    /***************************************************/
    $('#proceedPayment').click(function(event) {
        event.preventDefault();
        var $this = $(this);
        SwalOverlayColor();
        swal({
    ...
    /***************************************************/
    $('#setupDirectDebit').click(function(event) {
        event.preventDefault();
        var $this = $(this);

        swal({
                title: "Message",
                text: "Please Setup Your Payment Account for Direct Debit or Future Payments."
            })
            .then((value) => {
                if (value == true) {
                    var href = $this.attr('href');
