...
<div class="content_area">
    ...
    <div class="tables_area">
        ...
        <a href="{{ route('admin.trainingstyle.add')}}" class="blue_btn yellow_btn pull-right text-uppercase">Add
            New</a>
        <div class="clear"></div>
        ...
        <div class="white_box">
            <div class="table-responsive">
                <table width="100%" cellspacing="0" cellpadding="0" class="myDataTable">
                    ...
                    <tbody>
                        <?php
                        $i  = ($training_s->perPage() * ($training_s->currentPage() - 1)) + 1;
                        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.training.view',$training->id) }}" class="action_btn"><i
                                        class="fa fa-eye" aria-hidden="true"></i></a>
                                <a href="{{ route('admin.training.edit',$training->id) }}" class="action_btn"><i
                                        class="fa fa-edit" aria-hidden="true"></i></a>
                                <a href="{{ route('admin.training.delete',$training->id) }}"
