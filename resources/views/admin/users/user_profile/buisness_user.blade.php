						...
						<table width="100%" cellspacing="0" cellpadding="0">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="checkbox" class="toggle-status-class"  data-id="{{$user->id}}" data-toggle="toggle" data-on="Active" data-off="Suspend" data-onstyle="success" data-offstyle="danger" {{ $user->status == 'A' ? 'checked=true' : '' }}></td>
									...
									<td>
										...
										<a href="{{ route('admin.edit.buisnessUser',$user->id) }}" data-toggle="tooltip" data-placement="top" title="user.edit" class="action_btn" alt="edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
