...
class AdminController extends Controller
{
    ...
    public function personalUser()
    {
        ...
        ->where('account_complete', User::PROFILE_COMPLETE)->orderby('id', 'Desc')->paginate(20);
    ...
    public function coachList(){
        $coach_users = User::with('coach_detail','verification_detail')->where('role_type', User::ROLE_COACH)->where('account_complete', User::PROFILE_COMPLETE)->orderby('id', 'Desc')->paginate(15);
    ...
    public function updatePersonalUser(Request $request)
    {
        ...
        if ($user->save()) {
            ...
            return redirect()->route('personalUser');
        }
        return back();
    }
    ...
    public function updateBuisnessUser(Request $request)
    {
        ...
        if ($user->save()) {
            ...
            return redirect()->route('buisnessUser');
        }
        return back();
    }
    /*****************************************/
