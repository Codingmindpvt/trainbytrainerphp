...
Route::any('commission-edit', [AdminCommissionController::class, 'commissionEdit'])->name('admin.commission.edit');

//review
Route::any('review-list', [ReviewController::class, 'reviewList'])->name('admin.review.list');
