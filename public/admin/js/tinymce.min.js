...
!function(){"use strict";function n(t){return!(null==t)}function o(){}function r(t,e){return p.call(t,e)}function e(t){var e=t.command;return r(S,e)?function(t){if(n(t.value)&&r(t.value,"list-style-type")){t=t.value["list-style-type"];return"advlist_"+(""===t?"default":t)}}(t):r(g,e)?g[e]:r(_,e)?_[e]:r(v,e)?v[e]:void 0}function i(){return(new Date).getTime()}function t(t,e){var r,a,n,e=(r=t,a=e,{send:function(t,e,n){var t="?aid="+a+"&tna=tinymce_cloud&p=web&dtm="+e+"&stm="+i()+"&tz="+("undefined"!=typeof Intl?encodeURIComponent(Intl.DateTimeFormat().resolvedOptions().timeZone):"N%2FA")+"&e=se&se_ca="+t,o=document.createElement("img");o.src=r.chiffer_snowplow_service_url+t;t=function(t){return function(){o.onload=null,o.onerror=null,n(t)}};o.onload=t(!0),o.onerror=t(!1)}});return n=e,{sendStat:function(t){n.send(t,i(),o)}}}var a,c,s,u,d,l,m=(a="string",function(t){return t=typeof(e=t),(null===e?"null":"object"==t&&(Array.prototype.isPrototypeOf(e)||e.constructor&&"Array"===e.constructor.name)?"array":"object"==t&&(String.prototype.isPrototypeOf(e)||e.constructor&&"String"===e.constructor.name)?"string":t)===a;var e}),f=(c=void 0,function(t){return c===t}),p=Object.hasOwnProperty,_={mceInsertToc:"toc_insert",mceUpdateToc:"toc_update"},g={mceEditImage:"imagetools_open_dialog",mceImageRotateLeft:"imagetools_rotate",mceImageRotateRight:"imagetools_rotate",mceImageFlipVertical:"imagetools_flip",mceImageFlipHorizontal:"imagetools_flip"},S={InsertUnorderedList:!0,InsertOrderedList:!0},v={mceInsertTemplate:"template_insert",mceInsertDate:"insertdatetime_insert",mceInsertTime:"insertdatetime_insert",mcePreview:"preview_open_dialog",mceAnchor:"anchor_open_dialog"};u=tinymce.defaultSettings,d={load:o},l=function(t){t=t.api_key;return m(t)?t:void 0}(u),d=void 0===l?d:((s=t(u,l)).sendStat("script_load"),{load:function(t){t.once("init",function(){return s.sendStat("init")}),t.once("focus",function(){return s.sendStat("focus")}),t.on("ExportPdf",function(){return s.sendStat("export_pdf")}),t.on("PastePreProcess PowerPasteTempStats",function(t){t=t.source;n(t)&&s.sendStat("powerpaste_"+t)}),t.on("VisualChars",function(t){!0===t.state&&s.sendStat("visualchars_true")}),t.on("RtcSessionConnected",function(t){var e=t.time;switch(e){case 0:s.sendStat("rtc_started");break;case 5:case 10:case 20:s.sendStat("rtc_connected_"+e+"min")}}),t.on("RtcSessionError",function(){return s.sendStat("rtc_error")}),t.on("RtcSessionDirty",function(){return s.sendStat("rtc_edited")}),t.on("SpellcheckerLanguageChanged",function(t){t=t.language;s.sendStat("spellcheckerpro_language_changed_"+t)}),t.on("ExecCommand",function(t){t=e(t);f(t)||s.sendStat(t)})}}),tinymce.PluginManager.add("chiffer",d.load)}();
